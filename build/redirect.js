...
;// CONCATENATED MODULE: ./src/js/redirect.js
...
var timer_container = document.querySelector('div.timer-container');
var css_bg_color = getComputedStyle(timer_container).backgroundColor;
var bg_color = rgbHex(css_bg_color);
